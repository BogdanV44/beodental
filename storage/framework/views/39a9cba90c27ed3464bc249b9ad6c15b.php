            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    ...
                    <div class="hero-content">
                        ...
                        <div class="hero-content-body wow fadeInUp" data-wow-delay="0.5s">
                            <a href="<?php echo e(route('appointment')); ?>" class="btn-default">make an appointment</a>
                        </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="hero-image">
                        ...
                        <div class="hero-img">
                            <figure>
                                <img src="<?php echo e(asset('images/hero-img.png')); ?>" alt="beodental-clinic">
                            </figure>
                        </div>
                        <!-- Hero Img End -->
                        ...
                        <div class="export-dantist-box">
                            <div class="icon-box">
                                <figure class="image-anime">
                                    <img src="<?php echo e(asset('images/dantist-doctor-img.jpg')); ?>" alt="">
                                </figure>
                            </div>
                        ...
                        <div class="hero-icon-list">
                            <div class="hero-icon-box-1">
                                <img src="<?php echo e(asset('images/icon-hero-theeth-1.svg')); ?>" alt="">
                            </div>

                            <div class="hero-icon-box-2">
                                <img src="<?php echo e(asset('images/icon-hero-theeth-2.svg')); ?>" alt="">
                            </div>

                            <div class="hero-icon-box-3">
                                <img src="<?php echo e(asset('images/icon-hero-theeth-3.svg')); ?>" alt="">
                            </div>
                        </div>
                        <!-- Hero Icon List End -->
                        ...
                        <div class="icon-star-image">
                            <img src="<?php echo e(asset('images/icon-star.svg')); ?>" alt="">
                        </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-4 col-md-6 col-12">
                    ...
                    <div class="cta-box-item wow fadeInUp">
                        <div class="icon-box">
                            <img src="<?php echo e(asset('images/icon-cta-phone.svg')); ?>" alt="phone-icon">
                        </div>
                ...
                <div class="col-lg-4 col-md-6 col-12">
                    <div class="cta-box-item wow fadeInUp" data-wow-delay="0.25s">
                        <div class="icon-box">
                            <img src="<?php echo e(asset('images/icon-cta-time.svg')); ?>" alt="time-icon">
                        </div>
                        <div class="cta-box-content">
                            <h3>opening hours</h3>
                ...
                <div class="col-lg-4 col-md-12 col-12">
                    ...
                    <div class="cta-box-btn wow fadeInUp" data-wow-delay="0.5s">
                        <a href="<?php echo e(route('appointment')); ?>" class="btn-default btn-highlighted">make an appointment</a>
                    </div>
                    <!-- Cta Box Btn End -->
                </div>
            </div>
                    ...
                    <div class="about-image">
                        <div class="about-img-1">
                            <figure class="image-anime reveal">
                                <img src="<?php echo e(asset('images/about-us-img-1.jpg')); ?>" alt="about-beodental-clinic">
                            </figure>
                        </div>

                        <div class="about-img-2">
                            <figure class="image-anime reveal">
                                <img src="<?php echo e(asset('images/about-us-img-2.jpg')); ?>" alt="about-beodental-clinic-2">
                            </figure>
                        </div>
                        ...
                        <div class="about-experience">
                            <figure>
                                <img src="<?php echo e(asset('images/about-experience-circle.png')); ?>" alt="15-years-experience">
                            </figure>
                        </div>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="about-content">
                        ...
                        <div class="about-us-footer wow fadeInUp" data-wow-delay="0.75s">
                            <a href="<?php echo e(route('about')); ?>" class="btn-default">read more about us</a>
                        </div>
                        <!-- About Us Footer End -->
                    </div>
                    <!-- About Content End -->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="services-box-footer wow fadeInUp" data-wow-delay="1s">
                        <p>We believe in using the latest technology and techniques to ensure the best outcomes for our
                            patients.</p>
                        <a href="<?php echo e(route('services')); ?>" class="btn-default">view all service</a>
                    </div>
...
<?php echo $__env->make("front.layouts.layout", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\bogda\Herd\beodental\resources\views/front/pages/main/home.blade.php ENDPATH**/ ?>