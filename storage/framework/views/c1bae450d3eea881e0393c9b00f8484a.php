<?php $__env->startSection('tabTitle'); ?> Pediatric Dentistry <?php $__env->stopSection(); ?>
<?php $__env->startSection('pageTitleFirstWord'); ?>  Pediatric <?php $__env->stopSection(); ?>
<?php $__env->startSection('pageTitleSecondWord'); ?> Dentistry <?php $__env->stopSection(); ?>
<?php $__env->startSection('slug'); ?> Pediatric Dentistry <?php $__env->stopSection(); ?>
    ...
    <div class="service-single-content">
        ...
        <div class="service-featured-image">
            <figure class="reveal image-anime">
                <img src="<?php echo e(asset('images/pediatric-dentistry-1.jpg')); ?>" alt="">
            </figure>
        </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-12">
                        ...
                        <div class="service-entry-img-1">
                            <figure class="image-anime reveal">
                                <img src="<?php echo e(asset('images/pediatric-dentistry-2.jpg')); ?>" alt="">
                            </figure>
                        </div>
                    ...
                    <div class="col-md-6 col-12">
                        ...
                        <div class="service-entry-img-2">
                            <figure class="image-anime reveal">
                                <img src="<?php echo e(asset('images/pediatric-dentistry-3.jpg')); ?>" alt="">
                            </figure>
                        </div>
                        <!-- Service Entry Image End -->
                    </div>
...
<?php echo $__env->make("front.layouts.single-service-layout", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\bogda\Herd\beodental\resources\views/front/pages/services/pediatric-dentistry.blade.php ENDPATH**/ ?>