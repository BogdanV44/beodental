<?php $__env->startSection('tabTitle'); ?> Oral Surgery <?php $__env->stopSection(); ?>
<?php $__env->startSection('pageTitleFirstWord'); ?>  Oral <?php $__env->stopSection(); ?>
<?php $__env->startSection('pageTitleSecondWord'); ?> Surgery <?php $__env->stopSection(); ?>
<?php $__env->startSection('slug'); ?> Oral Surgery <?php $__env->stopSection(); ?>
    ...
    <div class="service-single-content">
        ...
        <div class="service-featured-image">
            <figure class="reveal image-anime">
                <img src="<?php echo e(asset('images/oral-surgery-1.jpg')); ?>" alt="">
            </figure>
        </div>
                ...
                <div class="row">
                    <div class="col-md-6 col-12">
                        ...
                        <div class="service-entry-img-1">
                            <figure class="image-anime reveal">
                                <img src="<?php echo e(asset('images/oral-surgery-2.jpg')); ?>" alt="">
                            </figure>
                        </div>
                    ...
                    <div class="col-md-6 col-12">
                        ...
                        <div class="service-entry-img-2">
                            <figure class="image-anime reveal">
                                <img src="<?php echo e(asset('images/oral-surgery-3.jpg')); ?>" alt="">
                            </figure>
                        </div>
                        <!-- Service Entry Image End -->
                    </div>
...
<?php echo $__env->make("front.layouts.single-service-layout", array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\bogda\Herd\beodental\resources\views/front/pages/services/oral-surgery.blade.php ENDPATH**/ ?>