...
<?php $component->withAttributes(['field' => $field]); ?>
    ...
    >
        <!--[if BLOCK]><![endif]--><?php if($isMultiple): ?>
            <!--[if BLOCK]><![endif]--><?php if(filled($optionLabels = $getOptionLabels())): ?>
                <div class="fi-fo-modal-table-select-badges-ctn">
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $optionLabels; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $optionLabel): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
            ...
            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
        <?php else: ?>
            <!--[if BLOCK]><![endif]--><?php if(filled($optionLabel = $getOptionLabel())): ?>
                <?php echo e($optionLabel); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\bogda\Herd\beodental\vendor\filament\forms\resources\views/components/modal-table-select.blade.php ENDPATH**/ ?>