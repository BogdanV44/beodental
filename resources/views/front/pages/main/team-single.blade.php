...
@section('tabTitle') {{$dentist->full_name}} @endsection

@section('pageTitleSecondWord') {{$dentist->full_name}} @endsection

@section('slug') Our Team <li class="breadcrumb-item active" aria-current="page">{{$dentist->full_name}}</li>  @endsection
                ...
                <div class="col-lg-5">
                    ...
                    <div class="team-member-image">
                        <figure class="image-anime">
                            <img src="{{asset('storage/' . $dentist->image_route)}}" alt="">
                        </figure>
                    </div>
                ...
                <div class="col-lg-7">
                    ...
                    <div class="team-member-details">
                        <div class="member-detail-header">
                            <h2 class="text-anime-style-2">{{$dentist->full_name}}</h2>
                            <p class="wow fadeInUp">{{$dentist->title}}</p>
                        </div>
                        <div class="member-detail-content">
                            <p class="wow fadeInUp" data-wow-delay="0.25s">{{$dentist->short_description}}</p>
                        </div>

                        <div class="member-detail-body wow fadeInUp" data-wow-delay="0.5s">
                            @if(strlen($dentist->email))
                                <ul>
                                    <li><span>Email</span>{{$dentist->email}}</li>
                                </ul>
                            @endif
                        </div>
    ...
    <div class="about-member-details">
        <div class="container">
            <div class="row justify-content-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="about-member-info">
                            ...
                            <div class="member-info-content">
                                <p class="wow fadeInUp" data-wow-delay="0.25s">{{$dentist->biography}}</p>
                            </div>
                        </div>
                ...
                @if(strlen($dentist->additional_description))
                    <div class="col-lg-8 mx-auto">
                        ...
                        <div class="about-member-info">
                            ...
                            <div class="member-info-content">
                                <p class="wow fadeInUp" data-wow-delay="0.25s">{{$dentist->additional_description}}</p>
                            </div>
                        </div>
                        <!-- About Member Info End -->
                    </div>
