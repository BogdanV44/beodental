...
@section('tabTitle') Contact @endsection
@section('pageTitleFirstWord')  Contact @endsection
@section('pageTitleSecondWord')  Us @endsection
@section('slug') Contact Us @endsection
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="contact-us-item wow fadeInUp" data-wow-delay="0.5s">
                                        <!-- Icon Box Start -->
                                        <div class="icon-box">
                                            <img src="{{asset('images/icon-clock.svg')}}" alt="clock-icon">
                                        </div>
                                        <!-- Icon Box End -->
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="contact-us-item wow fadeInUp" data-wow-delay="0.75s">
                                        <!-- Icon Box Start -->
                                        <div class="icon-box">
                                            <img src="{{asset('images/icon-mail.svg')}}" alt="mail-icon">
                                        </div>
                                        <!-- Icon Box End -->
